...
def fn_generate_linotype_file():
    ...
    linotype_file_contents = (
        ...
        f"# Line length: {line_length} {units_used}\n"
    ...
    def fn_line_can_be_sent(
        ...
        # The function asks: Is the target line_length somewhere between the current minimum possible line length and the current maximum possible line length?
        return (
            line_min_length <= line_length
            and
            line_length <= line_max_length
        )
    ...
    for character in input_text:
        ...
        # -----------------------------------------------------
            ...
            if fn_line_can_be_sent(
                ...
                # Try to finish after wedge space
        ...
        # -----------------------------------------------------
            ...
            character_width = keyboard_character["width"]


            # Check whether adding this character would
            # make the minimum length exceed the physical
            # maximum.
            ...
            if new_min_length > line_length:

                fn_log_error(
                    f"Character {character!r} "
                    f"(key {key_number}) would make "
                    f"the line too long"
                )
            ...
            line_min_length = new_min_length
            line_max_length = new_max_length
